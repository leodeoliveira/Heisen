            ...
            <form class="form theme-form">
              <div class="card-body">
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <label class="form-label" for="exampleFormControlInput5"
                        >Email address</label
                      >
                      <input
                ...
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <label class="form-label" for="exampleInputPassword6"
                        >Password</label
                      >
                      <input
                        class="form-control btn-pill"
                ...
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <label class="form-label" for="exampleFormControlSelect7"
                        >Example select</label
                      >
                      <select
                        class="form-select btn-pill digits"
                ...
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <label class="form-label" for="exampleFormControlSelect8"
                        >Example multiple select</label
                      >
                      <select
                        class="form-select btn-pill p-l-45 digits"
            ...
            <form class="form theme-form">
              <div class="card-body">
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <label class="form-label" for="exampleFormControlInput10"
                        >Email address</label
                      >
                      <input
                ...
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <label class="form-label" for="exampleInputPassword11"
                        >Password</label
                      >
                      <input
                        class="form-control btn-square"
                ...
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <label class="form-label" for="exampleFormControlSelect12"
                        >Example select</label
                      >
                      <select
                ...
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <label class="form-label" for="exampleFormControlSelect13"
                        >Example multiple select</label
                      >
                      <select
                        class="form-select btn-square digits"
            ...
            <form class="form theme-form">
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <label class="form-label" for="exampleInputPassword16"
                        >Password</label
                      >
                      <input
                        class="form-control input-air-primary"
                ...
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <label class="form-label" for="exampleFormControlSelect17"
                        >Example select</label
                      >
                      <select
                ...
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <label class="form-label" for="exampleFormControlSelect18"
                        >Example multiple select</label
                      >
                      <select
                        class="form-select input-air-primary digits"
                ...
                <div class="row">
                  <div class="col">
                    <div>
                      <label
                        class="form-label"
                        for="exampleFormControlTextarea19"
                        >Example textarea</label
                      >
                      <textarea
                        class="form-control input-air-primary"
            ...
            <form class="form theme-form">
              <div class="card-body">
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <label class="form-label" for="exampleFormControlInput20"
                        >Email address</label
                      >
                      <input
                        class="form-control"
                ...
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <label class="form-label" for="exampleInputPassword21"
                        >Password</label
                      >
                      <input
                        class="form-control"
                ...
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <label class="form-label" for="exampleInputPassword22"
                        >Disabled</label
                      >
                      <input
                        class="form-control"
                ...
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <label class="form-label" for="exampleFormControlSelect23"
                        >Example select</label
                      >
                      <select
                        class="form-select digits"
                ...
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <label class="form-label" for="exampleFormControlSelect24"
                        >Example multiple select</label
                      >
                      <select
                        class="form-select digits"
                ...
                <div class="row">
                  <div class="col">
                    <div>
                      <label
                        class="form-label"
                        for="exampleFormControlTextarea25"
                        >Example textarea</label
                      >
                      <textarea
                        class="form-control"
                        id="exampleFormControlTextarea25"
                        rows="3"
                      ></textarea>
                    </div>
                  </div>
            ...
            <form class="form theme-form">
              <div class="card-body">
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <label class="form-label" for="colFormLabelSm26"
                        >Large input</label
                      >
                      <input
                ...
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <label class="form-label" for="exampleInputPassword27"
                        >Default input</label
                      >
                      <input
                        class="form-control"
                ...
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <label class="form-label" for="colFormLabelSm28"
                        >Small input</label
                      >
                      <input
                ...
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <label class="form-label" for="exampleFormControlSelect29"
                        >Large select</label
                      >
                      <select
                        class="form-select form-control-lg digits"
                ...
                <div class="row">
                  <div class="col">
                    <div>
                      <label class="form-label" for="exampleFormControlSelect31"
                        >Small select</label
                      >
                      <select
                        class="form-select form-control-sm digits"
